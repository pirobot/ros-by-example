...
class MLP(LetterStatModel):
    ...
    def train(self, samples, responses):
        ...
        params = dict( term_crit = (cv2.TERM_CRITERIA_COUNT, 300, 0.1),
    ...
    def predict(self, samples):
        ...
        #output = np.zeros((samples.shape[0], self.class_n))
        output = cv.CreateMat(samples.shape[0], self.class_n, cv.CV_32FC1)
...
if __name__ == '__main__':
    ...
    args.setdefault('--data', '/home/patrick/tmp/letter-recognition.data')
